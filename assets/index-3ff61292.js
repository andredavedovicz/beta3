 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */(function(t){function e(A,V){var j=A.length;A.push(V);e:for(;0<j;){var ae=j-1>>>1,me=A[ae];if(0<i(me,V))A[ae]=V,A[j]=me,j=ae;else break e}}function n(A){return A.length===0?null:A[0]}function r(A){if(A.length===0)return null;var V=A[0],j=A.pop();if(j!==V){A[0]=j;e:for(var ae=0,me=A.length,Br=me>>>1;ae<Br;){var Mt=2*(ae+1)-1,rr=A[Mt],kt=Mt+1,ee=A[kt];if(0>i(rr,j))kt<me&&0>i(ee,rr)?(A[ae]=ee,A[kt]=j,ae=kt):(A[ae]=rr,A[Mt]=j,ae=Mt);else if(kt<me&&0>i(ee,j))A[ae]=ee,A[kt]=j,ae=kt;else break e}}return V}function i(A,V){var j=A.sortIndex-V.sortIndex;return j!==0?j:A.id-V.id}if(typeof performance=="object"&&typeof performance.now=="function"){var s=performance;t.unstable_now=function(){return s.now()}}else{var o=Date,a=o.now();t.unstable_now=function(){return o.now()-a}}var l=[],u=[],c=1,h=null,d=3,g=!1,v=!1,y=!1,E=typeof setTimeout=="function"?setTimeout:null,p=typeof clearTimeout=="function"?clearTimeout:null,f=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function m(A){for(var V=n(u);V!==null;){if(V.callback===null)r(u);else if(V.startTime<=A)r(u),V.sortIndex=V.expirationTime,e(l,V);else break;V=n(u)}}function w(A){if(y=!1,m(A),!v)if(n(l)!==null)v=!0,Hi(C);else{var V=n(u);V!==null&&Wi(w,V.startTime-A)}}function C(A,V){v=!1,y&&(y=!1,p(x),x=-1),g=!0;var j=d;try{for(m(V),h=n(l);h!==null&&(!(h.expirationTime>V)||A&&!rt());){var ae=h.callback;if(typeof ae=="function"){h.callback=null,d=h.priorityLevel;var me=ae(h.expirationTime<=V);V=t.unstable_now(),typeof me=="function"?h.callback=me:h===n(l)&&r(l),m(V)}else r(l);h=n(l)}if(h!==null)var Br=!0;else{var Mt=n(u);Mt!==null&&Wi(w,Mt.startTime-V),Br=!1}return Br}finally{h=null,d=j,g=!1}}var R=!1,N=null,x=-1,J=5,H=-1;function rt(){return!(t.unstable_now()-H<J)}function nr(){if(N!==null){var A=t.unstable_now();H=A;var V=!0;try{V=N(!0,A)}finally{V?vn():(R=!1,N=null)}}else R=!1}var vn;if(typeof f=="function")vn=function(){f(nr)};else if(typeof MessageChannel<"u"){var Uo=new MessageChannel,Pu=Uo.port2;Uo.port1.onmessage=nr,vn=function(){Pu.postMessage(null)}}else vn=function(){E(nr,0)};function Hi(A){N=A,R||(R=!0,vn())}function Wi(A,V){x=E(function(){A(t.unstable_now())},V)}t.unstable_IdlePriority=5,t.unstable_ImmediatePriority=1,t.unstable_LowPriority=4,t.unstable_NormalPriority=3,t.unstable_Profiling=null,t.unstable_UserBlockingPriority=2,t.unstable_cancelCallback=function(A){A.callback=null},t.unstable_continueExecution=function(){v||g||(v=!0,Hi(C))},t.unstable_forceFrameRate=function(A){0>A||125<A?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):J=0<A?Math.floor(1e3/A):5},t.unstable_getCurrentPriorityLevel=function(){return d},t.unstable_getFirstCallbackNode=function(){return n(l)},t.unstable_next=function(A){switch(d){case 1:case 2:case 3:var V=3;break;default:V=d}var j=d;d=V;try{return A()}finally{d=j}},t.unstable_pauseExecution=function(){},t.unstable_requestPaint=function(){},t.unstable_runWithPriority=function(A,V){switch(A){case 1:case 2:case 3:case 4:case 5:break;default:A=3}var j=d;d=A;try{return V()}finally{d=j}},t.unstable_scheduleCallback=function(A,V,j){var ae=t.unstable_now();switch(typeof j=="object"&&j!==null?(j=j.delay,j=typeof j=="number"&&0<j?ae+j:ae):j=ae,A){case 1:var me=-1;break;case 2:me=250;break;case 5:me=1073741823;break;case 4:me=1e4;break;default:me=5e3}return me=j+me,A={id:c++,callback:V,priorityLevel:A,startTime:j,expirationTime:me,sortIndex:-1},j>ae?(A.sortIndex=j,e(u,A),n(l)===null&&A===n(u)&&(y?(p(x),x=-1):y=!0,Wi(w,j-ae))):(A.sortIndex=me,e(l,A),v||g||(v=!0,Hi(C))),A},t.unstable_shouldYield=rt,t.unstable_wrapCallback=function(A){var V=d;return function(){var j=d;d=V;try{return A.apply(this,arguments)}finally{d=j}}}})(my);(function(t){t.exports=my})(k_);/**
 * @license React
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class pi{constructor(e){this.comparator=e?(n,r)=>e(n,r)||M.comparator(n.key,r.key):(n,r)=>M.comparator(n.key,r.key),this.keyedMap=us(),this.sortedSet=new Ce(this.comparator)}static emptySet(e){return new pi(e.comparator)}has(e){return this.keyedMap.get(e)!=null}get(e){return this.keyedMap.get(e)}first(){return this.sortedSet.minKey()}last(){return this.sortedSet.maxKey()}isEmpty(){return this.sortedSet.isEmpty()}indexOf(e){const n=this.keyedMap.get(e);return n?this.sortedSet.indexOf(n):-1}get size(){return this.sortedSet.size}forEach(e){this.sortedSet.inorderTraversal((n,r)=>(e(n),!1))}add(e){const n=this.delete(e.key);return n.copy(n.keyedMap.insert(e.key,e),n.sortedSet.insert(e,null))}delete(e){const n=this.get(e);return n?this.copy(this.keyedMap.remove(e),this.sortedSet.remove(n)):this}isEqual(e){if(!(e instanceof pi)||this.size!==e.size)return!1;const n=this.sortedSet.getIterator(),r=e.sortedSet.getIterator();for(;n.hasNext();){const i=n.getNext().key,s=r.getNext().key;if(!i.isEqual(s))return!1}return!0}toString(){const e=[];return this.forEach(n=>{e.push(n.toString())}),e.length===0?"DocumentSet ()":`DocumentSet (
  `+e.join(`  
`)+`
 ...
 *
 * @license MIT
 */function ld(){return ld=Object.assign?Object.assign.bind():function(t){for(var e=1;e<arguments.length;e++){var n=arguments[e];for(var r in n)Object.prototype.hasOwnProperty.call(n,r)&&(t[r]=n[r])}return t},ld.apply(this,arguments)}function vO(t,e){if(t==null)return{};var n={},r=Object.keys(t),i,s;for(s=0;s<r.length;s++)i=r[s],!(e.indexOf(i)>=0)&&(n[i]=t[i]);return n}function wO(t){return!!(t.metaKey||t.altKey||t.ctrlKey||t.shiftKey)}function EO(t,e){return t.button===0&&(!e||e==="_self")&&!wO(t)}const _O=["onClick","relative","reloadDocument","replace","state","target","to","preventScrollReset"];function SO(t){let{basename:e,children:n,window:r}=t,i=I.useRef();i.current==null&&(i.current=kD({window:r,v5Compat:!0}));let s=i.current,[o,a]=I.useState({action:s.action,location:s.location});return I.useLayoutEffect(()=>s.listen(a),[s]),I.createElement(gO,{basename:e,children:n,location:o.location,navigationType:o.action,navigator:s})}const TO=typeof window<"u"&&typeof window.document<"u"&&typeof window.document.createElement<"u",IO=/^(?:[a-z][a-z0-9+.-]*:|\/\/)/i,fa=I.forwardRef(function(e,n){let{onClick:r,relative:i,reloadDocument:s,replace:o,state:a,target:l,to:u,preventScrollReset:c}=e,h=vO(e,_O),{basename:d}=I.useContext(Lo),g,v=!1;if(typeof u=="string"&&IO.test(u)&&(g=u,TO)){let f=new URL(window.location.href),m=u.startsWith("//")?new URL(f.protocol+u):new URL(u),w=yp(m.pathname,d);m.origin===f.origin&&w!=null?u=w+m.search+m.hash:v=!0}let y=oO(u,{relative:i}),E=kO(u,{replace:o,state:a,target:l,preventScrollReset:c,relative:i});function p(f){r&&r(f),f.defaultPrevented||E(f)}return I.createElement("a",ld({},h,{href:g||y,onClick:v||s?r:p,ref:n,target:l}))});var ry;(function(t){t.UseScrollRestoration="useScrollRestoration",t.UseSubmitImpl="useSubmitImpl",t.UseFetcher="useFetcher"})(ry||(ry={}));var iy;(function(t){t.UseFetchers="useFetchers",t.UseScrollRestoration="useScrollRestoration"})(iy||(iy={}));function kO(t,e){let{target:n,replace:r,state:i,preventScrollReset:s,relative:o}=e===void 0?{}:e,a=$o(),l=Au(),u=XE(t,{relative:o});return I.useCallback(c=>{if(EO(c,n)){c.preventDefault();let h=r!==void 0?r:Pl(l)===Pl(u);a(t,{replace:h,state:i,preventScrollReset:s,relative:o})}},[l,a,u,r,i,n,t,s,o])}function CO({isAuth:t}){const[e,n]=I.useState([]),r=Tl(io,"postsexample"),i=async a=>{const l=x1(io,"postsexample",a);await sA(l)};let s=$o();I.useEffect(()=>{t||s("/login"),(async()=>{const l=await W1(o);n(l.docs.map(u=>({...u.data(),id:u.id})))})()},[i]);const o=XN(r,JN("postNumber","asc"));return S("div",{className:"bodyPage",children:S("div",{className:"homePage",children:e.map(a=>{var l;return F("div",{className:"post",children:[F("div",{className:"postHeader",children:[S("div",{className:"title",children:F("h1",{children:["OS#",a.postNumber]})}),S("div",{className:"deletePost",children:t&&mr.currentUser.uid==="Gy9XDtrBOfb09Y9RujCl0jON0jE2"&&S("button",{onClick:()=>{i(a.id)},children:"🗑"})})]}),F("div",{className:"content postTextContainer",children:[S("div",{className:"titles",children:"Data:"}),a.dateCreated]}),F("div",{className:"content postTextContainer",children:[S("div",{className:"titles",children:"Local:"}),a.title]}),F("div",{className:"content postTextContainer",children:[S("div",{className:"titles",children:"Objeto:"}),a.objeto]}),F("div",{className:"content postTextContainer",children:[S("div",{className:"titles",children:"Tipo:"}),a.tipo]}),F("div",{className:"content postTextContainer",children:[S("div",{className:"titles",children:"Status:"}),a.status]}),F("div",{className:"content postTextContainer",children:[S("div",{className:"titles",children:"Descrição:"}),a.postText]}),(l=a.imageListUrl)==null?void 0:l.map(u=>S("a",{href:u,target:"_blank",children:S("img",{className:"imagemOs",src:u,alt:u})})),F("h3",{children:["@",a.author.name]})]},a.postNumber)})})})}const JE=""+new URL("SMOBILIC-77a235b2.png",import.meta.url).href;function RO({setIsAuth:t}){let e=$o();const n=()=>{gP(mr,TD).then(c=>{localStorage.setItem("isAuth",!0),t(!0),e("/home")})},[r,i]=I.useState(),[s,o]=I.useState(!0),[a,l]=I.useState(!0);return F("div",{className:"loginPage",children:[F(qr,{children:[S("img",{src:JE,alt:"SMOBILI"}),F("h2",{children:["SISTEMA DE",S("br",{})," MANUTENÇÃO"]})]}),s?F(qr,{children:[F("div",{className:"inputPassword",children:[S("input",{className:"entrarInput",type:"text",value:r,onChange:c=>{i(c.target.value)}}),a?S(qr,{}):S("div",{className:"badPassword",children:"Senha está Incorreta!"})]}),S("button",{onClick:()=>{let c="maple@2023";r===c&&(o(!1),l(!0)),r!==c&&(o(!0),l(!1))},className:"entrarButton",children:"Permitir Acesso"})]}):F(qr,{children:[S("p",{children:"Entre com o Google para continuar:"}),S("button",{className:"login-with-google-btn",onClick:n,children:"Entrar com o Google"})]})]})}let pa;const NO=new Uint8Array(16);function AO(){if(!pa&&(pa=typeof crypto<"u"&&crypto.getRandomValues&&crypto.getRandomValues.bind(crypto),!pa))throw new Error("crypto.getRandomValues() not supported. See https://github.com/uuidjs/uuid#getrandomvalues-not-supported");return pa(NO)}const xe=[];for(let t=0;t<256;++t)xe.push((t+256).toString(16).slice(1));function PO(t,e=0){return(xe[t[e+0]]+xe[t[e+1]]+xe[t[e+2]]+xe[t[e+3]]+"-"+xe[t[e+4]]+xe[t[e+5]]+"-"+xe[t[e+6]]+xe[t[e+7]]+"-"+xe[t[e+8]]+xe[t[e+9]]+"-"+xe[t[e+10]]+xe[t[e+11]]+xe[t[e+12]]+xe[t[e+13]]+xe[t[e+14]]+xe[t[e+15]]).toLowerCase()}const xO=typeof crypto<"u"&&crypto.randomUUID&&crypto.randomUUID.bind(crypto),sy={randomUUID:xO};function DO(t,e,n){if(sy.randomUUID&&!e&&!t)return sy.randomUUID();t=t||{};const r=t.random||(t.rng||AO)();if(r[6]=r[6]&15|64,r[8]=r[8]&63|128,e){n=n||0;for(let i=0;i<16;++i)e[n+i]=r[i];return e}return PO(r)}function OO({isAuth:t},e){let n=$o();const[r,i]=I.useState(""),[s,o]=I.useState(""),[a,l]=I.useState(""),[u,c]=I.useState("Manutenção"),[h,d]=I.useState("Não Interrompe a atividade"),[g,v]=I.useState([]),[y,E]=I.useState([]),[p,f]=I.useState(0),m=Tl(io,"postsexample"),w=Tl(io,"postsexamplehistoric"),[C,R]=I.useState([]),[N,x]=I.useState([]),[J,H]=I.useState([]),[rt,nr]=I.useState(""),[vn,Uo]=I.useState(""),Pu=async()=>{r==""?j("red"):j("green"),s==""?me("red"):me("green"),g==""?kt("red"):kt("green"),a==""?Mt("red"):Mt("green"),r!==""&&s!==""&&a!==""&&g!==""?(await td(m,{title:r,objeto:s,tipo:u,status:h,postText:a,author:{name:mr.currentUser.displayName,id:mr.currentUser.uid},image:g,imageListUrl:y,postNumber:rt,dateCreated:vn}).then(()=>{td(w,{title:r,objeto:s,tipo:u,status:h,postText:a,author:{name:mr.currentUser.displayName,id:mr.currentUser.uid},image:g,imageListUrl:y,postNumber:rt,dateCreated:vn})}),n("/home")):alert("Formulário Inválido!")},Hi=()=>{nr(C.length+1)};I.useEffect(()=>{t||n("/login"),(async()=>{const Xt=await W1(w);R(Xt.docs.map(ir=>({...ir.data(),id:ir.id})))})(),p!=null&&f(y.length)},[y]);const Wi=ee=>{const Xt=new Date(ee),ir=Xt.getDate().toString().padStart(2,"0"),xu=(Xt.getMonth()+1).toString().padStart(2,"0"),Du=Xt.getFullYear(),qi=Xt.getHours().toString().padStart(2,"0"),Ou=Xt.getMinutes().toString().padStart(2,"0"),Lu=Xt.getSeconds().toString().padStart(2,"0");return`${ir}-${xu}-${Du} ${qi}:${Ou}:${Lu}`},A=()=>{if(N!=null)for(let ee of N)(ir=>{const xu=yD(ID,`imagesexample/${ir.name+DO()}`);return mD(xu,ir).then(Du=>{gD(Du.ref).then(qi=>{H(Mu=>[...Mu,qi]),v(qi),E(Mu=>[...Mu,qi]),kt("green"),Hi();const Ou=new Date().toISOString(),Lu=Wi(Ou);Uo(Lu)})})})(ee)},[V,j]=I.useState("inputGp"),[ae,me]=I.useState("inputGp"),[Br,Mt]=I.useState("inputGp"),[rr,kt]=I.useState("inputGp");return S("div",{className:"bodyPage",children:S("div",{className:"createPostPage",children:F("div",{className:"cpContainer",children:[F("div",{className:"inputGp",style:{border:`3px solid ${V}`},children:[S("label",{children:"Local:"}),S("input",{placeholder:"Local...",onChange:ee=>i(ee.target.value)})]}),F("div",{className:"inputGp",style:{border:`3px solid ${ae}`},children:[S("label",{children:"Objeto da Manutenção:"}),S("input",{placeholder:"Objeto...",onChange:ee=>o(ee.target.value)})]}),F("div",{className:"inputGp2",style:{border:`3px solid ${rr}`},children:[S("label",{children:"Registro Fotográfico:"}),S("input",{type:"file",className:"inputImg",onChange:ee=>{x(ee.target.files)},multiple:!0}),F("div",{className:"baixarImg",children:[S("button",{onClick:A,className:"buttonImg",style:{backgroundColor:`${rr}`},children:"Baixar Imagem"}),rr=="red"?g==""?F("div",{className:"icon",children:["❌ ",p]}):S("div",{className:"icon",children:"✔"}):"",F("div",{className:"downloadNumber",children:["(",p,")Imagens Salvas"]})]}),S("div",{className:"imagensOsCreate",children:y==null?void 0:y.map(ee=>S("a",{href:ee,target:"_blank",children:S("img",{className:"imagemOsCreate",src:ee,alt:ee})}))})]}),F("div",{className:"inputGp",style:{border:`3px solid ${Br}`},children:[S("label",{children:"Descrição:"}),S("textarea",{placeholder:"Descrição...",onChange:ee=>l(ee.target.value),className:"description"})]}),F("div",{className:"inputGp",children:[S("label",{children:"Tipo de Manutenção:"}),F("select",{onChange:ee=>c(ee.target.value),children:[S("option",{value:"Manutenção",children:"Manutenção"}),S("option",{value:"Melhoria",children:"Melhoria"}),S("option",{value:"Investimento",children:"Investimento"})]})]}),F("div",{className:"inputGp",children:[S("label",{children:"Manutenção interrompe a atividade? "}),F("select",{onChange:ee=>d(ee.target.value),children:[S("option",{value:"Não Interrompe a atividade",children:"Não"}),S("option",{value:"Interrompe a atividade",children:"Sim"})]})]}),S("button",{className:"submit-post",onClick:Pu,children:"Enviar"})]})})})}const LO=()=>F("div",{className:"loginPage",children:[S("img",{src:JE,alt:"SMOBILI"}),F("h2",{children:["SISTEMA DE",S("br",{})," MANUTENÇÃO"]})]});function MO({formData:t,setFormData:e}){return F("div",{className:"sign-up-container",children:[S("input",{type:"text",placeholder:"Nome Fantasia...",value:t.nomeFantasia,onChange:n=>e({...t,nomeFantasia:n.target.value})}),S("input",{type:"text",placeholder:"Razão Social...",value:t.razaoSocial,onChange:n=>e({...t,razaoSocial:n.target.value})}),S("input",{type:"text",placeholder:"CNPJ...",value:t.cnpj,onChange:n=>e({...t,cnpj:n.target.value})}),S("input",{type:"text",placeholder:"Regime Tributário...",value:t.regimeTributario,onChange:n=>e({...t,regimeTributario:n.target.value})}),S("input",{type:"text",placeholder:"ie...",value:t.ie,onChange:n=>e({...t,ie:n.target.value})}),S("input",{type:"text",placeholder:"im...",value:t.im,onChange:n=>e({...t,im:n.target.value})}),S("input",{type:"text",placeholder:"CEP...",value:t.cep,onChange:n=>e({...t,cep:n.target.value})}),S("input",{type:"text",placeholder:"Endereço...",value:t.endereco,onChange:n=>e({...t,endereco:n.target.value})})]})}function $O({formData:t,setFormData:e}){return F("div",{className:"personal-info-container",children:[S("input",{type:"text",placeholder:"Seu nome...",value:t.nome,onChange:n=>{e({...t,nome:n.target.value})}}),S("input",{type:"text",placeholder:"Função Principal...",value:t.cargo,onChange:n=>{e({...t,cargo:n.target.value})}}),S("input",{type:"text",placeholder:"email...",value:t.email,onChange:n=>{e({...t,email:n.target.value})}}),S("input",{type:"text",placeholder:"celular...",value:t.celular,onChange:n=>{e({...t,celular:n.target.value})}}),S("input",{type:"text",placeholder:"Conta corrente...",value:t.contaCorrente,onChange:n=>{e({...t,contaCorrente:n.target.value})}}),S("input",{type:"text",placeholder:"PIX...",value:t.pix,onChange:n=>{e({...t,pix:n.target.value})}})]})}function UO({formData:t,setFormData:e}){const[n,r]=I.useState([]),[i,s]=I.useState(""),[o,a]=I.useState([]),[l,u]=I.useState(""),c=E=>{const p=E.target.value;s(p)},h=()=>{r([...n,i]),s(""),e({...t,referencias:n})},d=()=>{e({...t,referencias:n.pop()})},g=E=>{const p=E.target.value;u(p)},v=()=>{a([...o,l]),u(""),e({...t,areasDeAtuação:o})},y=()=>{e({...t,areasDeAtuação:o.pop()})};return I.useEffect(()=>{e({...t,areasDeAtuação:o})},[o,e]),I.useEffect(()=>{e({...t,referencias:n})},[n,e]),F("div",{className:"other-info-container",children:[F("label",{className:"labelOtherInfo",children:[S("div",{className:"label",children:"Referencias:"}),S("input",{type:"text",value:i,onChange:c})]}),F("div",{className:"options",children:[S("button",{className:"add",type:"button",onClick:h,children:"Adicionar"}),S("button",{className:"buttonTrash",onClick:()=>{d()},children:"🗑"})]}),S("ul",{children:n.map((E,p)=>S("li",{className:"list",children:E},p))}),F("label",{className:"labelOtherInfo",children:[S("div",{className:"label",children:"Todas as funções:"}),S("input",{type:"text",value:l,onChange:g})]}),F("div",{className:"options",children:[S("button",{className:"add",type:"button",onClick:v,children:"Adicionar"}),S("button",{className:"buttonTrash",onClick:()=>{y()},children:"🗑"})]}),S("ul",{children:o.map((E,p)=>S("li",{children:E},p))})]})}function bO(){const[t,e]=I.useState(0),[n,r]=I.useState({nomeFantasia:"",razaoSocial:"",cnpj:"",regimeTributario:"",ie:"",im:"",endereco:"",cep:"",referencias:"",areasDeAtuação:"",nome:"",cargo:"",email:"",celular:"",contaCorrente:"",pix:""}),i=["Seus Dados","Dados da Empresa","Outras Informações"],s=()=>t===0?S($O,{formData:n,setFormData:r}):t===1?S(MO,{formData:n,setFormData:r}):S(UO,{formData:n,setFormData:r}),o=Tl(io,"credentials");let a=$o();const l=async()=>{await td(o,{nomeFantasia:n.nomeFantasia,razaoSocial:n.razaoSocial,cnpj:n.cnpj,regimeTributario:n.regimeTributario,ie:n.ie,im:n.im,endereco:n.endereco,cep:n.cep,referencias:n.referencias,areasDeAtuação:n.areasDeAtuação,nome:n.nome,cargo:n.cargo,email:n.email,celular:n.celular,contaCorrente:n.contaCorrente,pix:n.pix}),a("/")};return F("div",{className:"form",children:[S("div",{className:"progressbar",children:S("div",{style:{width:t===0?"33.3%":t==1?"66.6%":"100%"}})}),F("div",{className:"form-container",children:[S("div",{className:"header",children:S("h1",{children:i[t]})}),S("div",{className:"body",children:s()}),F("div",{className:"footer",children:[S("button",{disabled:t==0,onClick:()=>{e(u=>u-1)},children:"Anterior"}),S("button",{onClick:()=>{t===i.length-1?(alert("FORM SUBMITTED"),console.log(n),l()):e(u=>u+1)},children:t===i.length-1?"Enviar":"Próximo"})]})]})]})}function FO(){const[t,e]=I.useState(localStorage.getItem("isAuth"));return F(SO,{children:[S("nav",{children:t?F(qr,{children:[S(fa,{className:"links",to:"/home",children:"OS's"}),S(fa,{className:"links",to:"/createpost",children:"Criar OS"}),S("button",{className:"sair",onClick:()=>{QA(mr).then(()=>{localStorage.clear(),e(!1),window.location.pathname="/login"})},children:"Sair"})]}):F(qr,{children:[S(fa,{className:"links",to:"/login",children:"Cliente"}),S(fa,{className:"links",to:"/credentials",children:"Credenciado"})]})}),F(yO,{children:[S(Wr,{path:"/",element:S(LO,{})}),S(Wr,{path:"/home",element:S(CO,{isAuth:t})}),S(Wr,{path:"/createpost",element:S(OO,{isAuth:t})}),S(Wr,{path:"/login",element:S(RO,{setIsAuth:e})}),S(Wr,{path:"/credentials",element:S(bO,{})})]})]})}Dc.createRoot(document.getElementById("root")).render(S(fy.StrictMode,{children:S(FO,{})}));
